...
namespace LottieSharp.Parser
{
    public static class AnimatableValueParser
    {
        ...
        {
            return new AnimatableFloatValue(Parse(reader, isDp ? Utils.Utils.DpScale() : 1f, composition,
        ...
        {
            return new AnimatableShapeValue(Parse(reader, Utils.Utils.DpScale(), composition,
                ShapeDataParser.Instance));
        }
