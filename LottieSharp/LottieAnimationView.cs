...
namespace LottieSharp
{
    ...
    public class LottieAnimationView : UserControl, IDisposable
    {
        ...
        public static readonly DependencyProperty ColorFilterProperty =
            DependencyProperty.Register("ColorFilter", typeof(Color), typeof(LottieAnimationView), new PropertyMetadata(Color.Transparent));
        ...
        */
        ...
        public virtual async Task SetAnimationAsync(string assetName)
        {
            ...
            try
            {
                var compositionResult = await LottieCompositionFactory.FromAsset(_lottieDrawable.RenderTarget, assetName, cancellationTokenSource.Token);
        ...
        /// Return either one of <see cref="LottieSharp.RepeatMode.Reverse"/> or <see cref="LottieSharp.RepeatMode.Restart"/>
        /// </summary>
        ...
        /// greater than 0 or <see cref="LottieSharp.RepeatMode.Infinite"/>, the repeat mode will be taken 
        /// into account. The repeat count is 0 by default. 
        /// 
        /// Count the number of times the animation should be repeated
        /// 
        /// Return the number of times the animation should repeat, or <see cref="LottieSharp.RepeatMode.Infinite"/>
        /// </summary>
